        ...
        private void pictureBox1_Paint(object sender, PaintEventArgs e)
        {
           float vec = RY.dist(RY.position, RY.Vector3(0.0f, 0.0f, 20.0f));
            ...
            if (vec < 130)
            {
                 ...
                 */
                RY.shapes.rectngularpyrism(RY.Vector3(pictureBox1.Width / 2 + (int)RY.x_, pictureBox1.Height / 2, -30.0f), new Size((int)vec, (int)vec + 10), Color.BlueViolet, e.Graphics);//
            ...
            if (vec_ < 130)//
                RY.shapes.rectngularpyrism(RY.Vector3(pictureBox1.Width / 2 + (int)RY.x_+30, pictureBox1.Height / 2, -20.0f), new Size((int)vec_, (int)vec_+10 ), Color.Orange, e.Graphics);//+ 10
